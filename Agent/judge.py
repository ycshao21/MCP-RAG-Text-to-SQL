...
def judge(query, entities=None):
    ...
    Output Format:
    {{
        "task1": {{ "description": "", "sql": "", "result": "" ,"is_finished": "" }},
        "task2": {{ "description": "", "sql": "", "result": "" ,"is_finished": "" }}
    }}
    ...
    Example Output:
    {{
        "task1": {{ "description": "Calculate the total sales for products in the 'Electronics' category with a price above $100.", "sql": "", "result": "" ,"is_finished": "" }},
        "task2": {{ "description": "Identify the top 5 customers who purchased the most from the 'Electronics' category.", "sql": "", "result": "" ,"is_finished": "" }}
    }}
    """
...
if __name__ == "__main__":
    print(judge("查询上海过去一周中午12点的平均气温","上海过去一周的气温表，记录每一天中午12点的温度"))